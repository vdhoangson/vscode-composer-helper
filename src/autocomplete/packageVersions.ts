...
export const packageVersionsCIP =
  vscode.languages.registerCompletionItemProvider(globals.documentSelector, {
    async provideCompletionItems(
      ...
      let packageVersions = await PackagistProvider.getPackageVersions(
        packageName
      );
