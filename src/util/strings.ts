...
export class Strings {
  ...
  static ComposerArchiveInput =
    "Optional. Input options, package name and/or version to archive.";
  ...
  static ComposerSuggestsInput =
    "Input options and the name(s) of the package(s) that you want to list suggestions from.";
  ...
  static ComposerRequireInput =
    "Input options and the name(s) of the package(s) to add";
  static ComposerRequirePlaceHolder = "[options] [--] [<packages>] ...";

  static ComposerRemoveInput =
    "Input options and the name(s) of the package(s) to remove";
  static ComposerRemovePlaceHolder = "[options] [--] [<packages>] ...";

  static ComposerRunScriptInput = "";
  static ComposerRunScriptPlaceHolder =
    "[options] [--] [<script>] [<args>] ...";
  ...
  static WorkspaceFolderPick =
    "Select workspace folder to run composer command ...";

  // Errors
  static ComposerExecutablePathRequired =
    "Please set composer.executablePath in your user settings in order to to access composer features.";
  static ComposerNotFound = "Composer could not be found in the system.";
  static ComposerContextRequired =
    "Please open a workspace folder in order to access composer features.";
  static ComposerProjectRequired =
    "Open a folder with a composer project in order to access composer features.";
  static ComposerCommandNotImplemented =
    'The composer "{0}" command is not implemented';
}
